...
export const MODERATION_I18N_KEYS = {
  ...
  queueFilters: "moderation.queue.filters",
  queueFiltersApply: "moderation.queue.filtersApply",
  ...
  caseUntitled: "moderation.case.untitled",
  caseLeaseOtherAnonymous: "moderation.case.leaseOtherAnonymous",
...
export const moderationI18nBundleEn: I18nDictionary = {
  ...
  "moderation.queue.noTargetTypes": "There are no content kinds to filter by.",
  "moderation.queue.col.state": "State",
  "moderation.queue.col.target": "Content",
  "moderation.queue.col.origin": "How it opened",
  ...
  "moderation.queue.filters": "Filters",
  "moderation.queue.filtersApply": "Show results",
  "moderation.queue.filtersClear": "Clear all",
  "moderation.queue.filtersNone": "Everything in the queue",
  ...
  "moderation.case.leaseOtherAnonymous":
    "Another moderator is holding this case until {until}.",
  ...
  // A plural FAMILY (rendered through `tPlural`): the flat base stays as the
  // last-resort fallback the engine reaches for, and parity is asserted on it.
  "moderation.case.reportCount": "{count} reports",
  "moderation.case.reportCount.one": "{count} report",
  "moderation.case.reportCount.other": "{count} reports",
