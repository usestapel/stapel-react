 ...
 */
import { MODERATION_ERRORS } from "./generated/errors.gen.js";
 ...
 */
export function explainModerationError(code: string): Remediation | undefined {
  return (MODERATION_ERRORS as Record<string, { remediation: Remediation }>)[code]
    ?.remediation;
}
