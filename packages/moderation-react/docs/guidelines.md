# Moderation — frontend guidelines
...
for @stapel/moderation-react and what has been decided for its screens. It is a stub on
...
- 2026-.. — scaffolded; `ModerationPanel` is a skeleton (themed frame +
