...
for @stapel/webhooks-react and what has been decided for its screens. It is a stub on
...
- 2026-.. — scaffolded; `WebhooksPanel` is a skeleton (themed frame +
