 ...
 */
import { WEBHOOKS_ERRORS } from "./generated/errors.gen.js";
 ...
 */
export function explainWebhooksError(code: string): Remediation | undefined {
  return (WEBHOOKS_ERRORS as Record<string, { remediation: Remediation }>)[code]
    ?.remediation;
}
