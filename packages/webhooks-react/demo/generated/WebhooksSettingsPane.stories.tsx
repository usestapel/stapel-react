...
import demo from "../WebhooksSettingsPane.demo.js";

export default { title: "webhooks-react / Webhooks (developer settings)" };
...
Phone.parameters = { stapel: {"viewport":"phone","step":"ready_phone"} };
