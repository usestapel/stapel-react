...
import demo from "../DeliveriesPane.demo.js";

export default { title: "webhooks-react / Delivery log" };

export const Default = (): ReactElement => renderDemoVariant(demo, "default");
Default.storyName = "default";
Default.parameters = { stapel: {"viewport":"desktop","step":"mixed"} };
...
export const DeadLetter = (): ReactElement => renderDemoVariant(demo, "dead-letter");
DeadLetter.storyName = "dead-letter";
DeadLetter.parameters = { stapel: {"viewport":"desktop","step":"dead"} };
