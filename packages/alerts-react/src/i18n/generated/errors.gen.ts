...
export interface AlertsErrorSpec {
...
/**
 * The ALERTS_ERRORS map — every `error.*` key stapel-auth can raise, keyed by its
 ...
 */
export const ALERTS_ERRORS = {
  "error.400.alerts_batch_too_large": { status: 400, params: ["max"], remediation: "fix_input", en: "Too many events in one report (max {max})" },
  "error.400.alerts_invalid_report": { status: 400, params: [], remediation: "fix_input", en: "The report payload is malformed" },
  "error.400.alerts_status_not_settable": { status: 400, params: ["status"], remediation: "fix_input", en: "Status {status} is set by the store from evidence and cannot be assigned" },
  ...
  "error.401.alerts_service_key_required": { status: 401, params: [], remediation: "reauthenticate", en: "A service key or a staff session is required" },
  ...
  "error.403.alerts_service_key_invalid": { status: 403, params: [], remediation: "retry", en: "This service key is not valid" },
  ...
  "error.404.alerts_issue_not_found": { status: 404, params: [], remediation: "retry", en: "Issue not found" },
...
export type AlertsErrorCode = keyof typeof ALERTS_ERRORS;

/** Every backend error code this module can surface, sorted. */
export const ALERTS_ERROR_CODES: readonly AlertsErrorCode[] = [
 ...
 */
export const alertsErrorBundleEn: Record<AlertsErrorCode, string> = {
  "error.400.alerts_batch_too_large": "Too many events in one report (max {max})",
  "error.400.alerts_invalid_report": "The report payload is malformed",
  "error.400.alerts_status_not_settable": "Status {status} is set by the store from evidence and cannot be assigned",
  ...
  "error.401.alerts_service_key_required": "A service key or a staff session is required",
  "error.401.unauthorized": "Authentication required",
  "error.402.payment_required": "Payment required",
  "error.403.alerts_service_key_invalid": "This service key is not valid",
  ...
  "error.404.alerts_issue_not_found": "Issue not found",
