 ...
 */
import { ALERTS_ERRORS } from "./generated/errors.gen.js";
 ...
 */
export function explainAlertsError(code: string): Remediation | undefined {
  return (ALERTS_ERRORS as Record<string, { remediation: Remediation }>)[code]
    ?.remediation;
}
