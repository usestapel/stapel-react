...
- 5225414: The audio intake — a recording finally has somewhere to go.
...
- a50d068: A microphone, and one file in / one CDN key out.
...
- cdfb9b9: The picture fills its square cell, whatever shape the photograph is.
...
- 4daa427: The add tile is actually square, and the overlay chrome fits the tile.
...
- 6b0e157: The photo gallery is a grid of square tiles.
...
- 9fd92b2: The uploaded photo tile carries badges, not paragraphs.
...
- 30f3208: The upload queue stops writing state into a control that has gone away.
