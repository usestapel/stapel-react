...
export const CDN_ERRORS = {
  ...
  "error.400.too_many_refs": { status: 400, params: ["count","max"], remediation: "fix_input", en: "Too many references in one request ({count}; the maximum is {max})" },
  ...
  "error.404.media_not_found": { status: 404, params: [], remediation: "retry", en: "Media not found or link expired" },
...
export const CDN_ERROR_CODES: readonly CdnErrorCode[] = [
 ...
 */
export const cdnErrorBundleEn: Record<CdnErrorCode, string> = {
  ...
  "error.400.too_many_refs": "Too many references in one request ({count}; the maximum is {max})",
  ...
  "error.404.media_not_found": "Media not found or link expired",
