...
export const PROFILES_I18N_KEYS = {
  ...
  fieldCurrency: "profiles.settings.field.currency",
  fieldUnits: "profiles.settings.field.units",
  unitsMetric: "profiles.settings.units.metric",
  unitsImperial: "profiles.settings.units.imperial",
  ...
  fieldUseDeviceLanguage: "profiles.language.field.use_device_language",
...
export const profilesI18nBundleEn: I18nDictionary = {
  ...
  "profiles.settings.field.currency": "Currency",
  "profiles.settings.field.units": "Units",
  "profiles.settings.units.metric": "Metric",
  "profiles.settings.units.imperial": "Imperial",
  ...
  "profiles.language.subtitle": "The language stapel-translate serves your UI in.",
  "profiles.language.field.app_language": "App language",
  "profiles.language.field.use_device_language": "Use device language",
