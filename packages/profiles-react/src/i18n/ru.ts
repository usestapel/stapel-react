...
export const profilesI18nBundleRu: I18nDictionary = {
  ...
  "profiles.settings.field.currency": "Валюта",
  "profiles.settings.field.units": "Единицы измерения",
  "profiles.settings.units.metric": "Метрические",
  "profiles.settings.units.imperial": "Имперские",
  ...
  "profiles.language.subtitle": "Язык, на котором stapel-translate обслуживает интерфейс.",
  "profiles.language.field.app_language": "Язык интерфейса",
  "profiles.language.field.use_device_language": "Использовать язык устройства",
