...
export const profilesI18nBundleRu: I18nDictionary = {
  ...
  "profiles.seller.tab.overview": "Главная",
  "profiles.seller.tab.listings": "Объявления",
  "profiles.seller.tab.reviews": "Отзывы",
  ...
  "profiles.contacts.title": "Телефоны",
  "profiles.contacts.subtitle":
    "Номера, которые покупатель может запросить. Вы решаете, кому их выдавать, и видите, как часто их запрашивали.",
  "profiles.contacts.empty": "Вы ещё не добавили номер",
  "profiles.contacts.empty_hint":
    "Добавьте номер и подтвердите его по SMS — до подтверждения его никто не получит.",
  "profiles.contacts.show_number": "Показать номер",
  "profiles.contacts.hide_number": "Скрыть номер",
  "profiles.contacts.verified": "Подтверждён",
  "profiles.contacts.unverified": "Не подтверждён",
  "profiles.contacts.unverified_hint":
    "Подтвердите номер по SMS — до этого его никто не получит.",
  "profiles.contacts.policy_label": "Кому выдавать",
  "profiles.contacts.policy.members": "Любому с аккаунтом",
  "profiles.contacts.policy.verified": "Только подтверждённым аккаунтам",
  "profiles.contacts.policy.nobody": "Никому",
  "profiles.contacts.enabled_label": "Включён",
  "profiles.contacts.label_field": "Название",
  "profiles.contacts.label_placeholder": "Рабочий",
  "profiles.contacts.number_field": "Номер телефона",
  "profiles.contacts.number_placeholder": "+15550100",
  "profiles.contacts.add": "Добавить номер",
  "profiles.contacts.adding": "Добавляем…",
  "profiles.contacts.delete": "Удалить",
  "profiles.contacts.confirm_delete.title": "Удалить этот номер?",
  "profiles.contacts.confirm_delete.body":
    "Его перестанут выдавать, и записи о том, кто его запрашивал, тоже будут удалены.",
  "profiles.contacts.reveals.total": "Выдан всего раз: {count}",
  "profiles.contacts.reveals.last_24h": "{count} за последние 24 часа",
  "profiles.contacts.reveals.last_7d": "{count} за последние 7 дней",
  "profiles.contacts.verify": "Подтвердить по SMS",
  "profiles.contacts.verify.sending": "Отправляем…",
  "profiles.contacts.verify.sent": "Мы отправили код на этот номер.",
  "profiles.contacts.verify.expires_in": "Код действует {seconds} секунд.",
  "profiles.contacts.verify.code_field": "Код из SMS",
  "profiles.contacts.verify.code_placeholder": "123456",
  "profiles.contacts.verify.confirm": "Подтвердить",
  "profiles.contacts.verify.confirming": "Подтверждаем…",
  "profiles.contacts.verify.resend": "Отправить код ещё раз",
  "profiles.contacts.verify.cancel": "Не сейчас",
  "profiles.contacts.verify.attempts_left.one": "Осталась {count} попытка.",
  "profiles.contacts.verify.attempts_left.few": "Осталось {count} попытки.",
  "profiles.contacts.verify.attempts_left.many": "Осталось {count} попыток.",
  "profiles.contacts.verify.attempts_left.other": "Осталось {count} попыток.",
  "profiles.contacts.reveal.show": "Показать телефон",
  "profiles.contacts.reveal.loading": "Запрашиваем…",
  "profiles.contacts.reveal.none": "У этого продавца нет телефона для показа.",
  "profiles.contacts.reveal.budget.one":
    "Слишком много запросов телефона. Повторите через {count} минуту.",
  "profiles.contacts.reveal.budget.few":
    "Слишком много запросов телефона. Повторите через {count} минуты.",
  "profiles.contacts.reveal.budget.many":
    "Слишком много запросов телефона. Повторите через {count} минут.",
  "profiles.contacts.reveal.budget.other":
    "Слишком много запросов телефона. Повторите через {count} минут.",
  "profiles.contacts.reveal.register":
    "Зарегистрируйтесь, чтобы увидеть телефон продавца.",
  "profiles.contacts.reveal.copy": "Скопировать",
  "profiles.contacts.reveal.copied": "Скопировано",
  "profiles.contacts.reveal.call": "Позвонить: {label}",
  "profiles.nav.settings": "Настройки",
  "profiles.nav.language": "Язык",
  "profiles.nav.notifications": "Уведомления",
  "profiles.nav.contacts": "Телефоны",
