...
export interface ProfilesErrorSpec {
...
/**
 * The PROFILES_ERRORS map — every `error.*` key stapel-auth can raise, keyed by its
...
export const PROFILES_ERRORS = {
  ...
  "error.400.contacts_code_expired": { status: 400, params: [], remediation: "retry", en: "That code is no longer valid. Ask for a new one." },
  "error.400.contacts_invalid_code": { status: 400, params: ["attempts_remaining"], remediation: "fix_input", en: "Wrong code. {attempts_remaining} attempt(s) left." },
  "error.400.contacts_invalid_phone": { status: 400, params: [], remediation: "fix_input", en: "Enter the phone number in international form, starting with +" },
  "error.400.contacts_invalid_policy": { status: 400, params: ["policies"], remediation: "fix_input", en: "Unknown visibility policy. Allowed here: {policies}" },
  ...
  "error.400.invalid_avatar_format": { status: 400, params: [], remediation: "fix_input", en: "Invalid avatar reference format. Expected: avatar/<hash>" },
  "error.400.invalid_currency": { status: 400, params: [], remediation: "fix_input", en: "Invalid currency code" },
  "error.400.too_many_ids": { status: 400, params: ["requested","limit"], remediation: "fix_input", en: "Too many ids: {requested} requested, at most {limit} per batch request" },
  ...
  "error.403.contacts_registration_required": { status: 403, params: [], remediation: "reauthenticate", en: "Register an account to see a seller's phone number" },
  ...
  "error.404.contact_not_found": { status: 404, params: [], remediation: "fix_input", en: "Contact not found" },
  "error.404.not_found": { status: 404, params: [], remediation: "retry", en: "Requested resource not found" },
  "error.404.profile_not_found": { status: 404, params: [], remediation: "fix_input", en: "Profile not found" },
  ...
  "error.409.contacts_duplicate": { status: 409, params: [], remediation: "fix_input", en: "You have already added this number" },
  ...
  "error.429.contacts_code_rate": { status: 429, params: ["retry_after"], remediation: "wait_and_retry", en: "Too many attempts. Try again in {retry_after} seconds." },
  "error.429.contacts_reveal_budget": { status: 429, params: ["retry_after"], remediation: "wait_and_retry", en: "Too many phone lookups. Try again in {retry_after} seconds." },
  ...
  "error.503.contacts_code_unavailable": { status: 503, params: [], remediation: "retry", en: "The code could not be sent right now. Try again shortly." },
...
export const profilesErrorBundleEn: Record<ProfilesErrorCode, string> = {
  ...
  "error.400.contacts_code_expired": "That code is no longer valid. Ask for a new one.",
  "error.400.contacts_invalid_code": "Wrong code. {attempts_remaining} attempt(s) left.",
  "error.400.contacts_invalid_phone": "Enter the phone number in international form, starting with +",
  "error.400.contacts_invalid_policy": "Unknown visibility policy. Allowed here: {policies}",
  ...
  "error.400.invalid_avatar_format": "Invalid avatar reference format. Expected: avatar/<hash>",
  "error.400.invalid_currency": "Invalid currency code",
  "error.400.too_many_ids": "Too many ids: {requested} requested, at most {limit} per batch request",
  ...
  "error.403.contacts_registration_required": "Register an account to see a seller's phone number",
  ...
  "error.404.profile_not_found": "Profile not found",
  ...
  "error.409.contacts_duplicate": "You have already added this number",
  ...
  "error.429.contacts_code_rate": "Too many attempts. Try again in {retry_after} seconds.",
  "error.429.contacts_reveal_budget": "Too many phone lookups. Try again in {retry_after} seconds.",
  ...
  "error.503.contacts_code_unavailable": "The code could not be sent right now. Try again shortly.",
