/**
 * Shared harness for the tasks-react demos (frontend-guardrails §4.2). Demos
 ...
 * demo needs: query client, i18n, and the tasks runtime.
...
/**
 * Provider frame every tasks demo variant renders inside. Builds a fresh mock
 * runtime + query client per mount so variants stay isolated.
 */
export function TasksDemoHarness(props: {
