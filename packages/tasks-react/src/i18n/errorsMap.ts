 ...
 */
import { TASKS_ERRORS } from "./generated/errors.gen.js";
 ...
 */
export function explainTasksError(code: string): Remediation | undefined {
  return (TASKS_ERRORS as Record<string, { remediation: Remediation }>)[code]
    ?.remediation;
}
