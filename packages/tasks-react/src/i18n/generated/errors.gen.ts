...
export interface TasksErrorSpec {
...
/**
 * The TASKS_ERRORS map — every `error.*` key stapel-auth can raise, keyed by its
...
export const TASKS_ERRORS = {
  ...
  "error.400.tasks_invalid_checklist_state": { status: 400, params: [], remediation: "fix_input", en: "Checklist state must be one of: pending, done, failed" },
  "error.400.tasks_invalid_column": { status: 400, params: [], remediation: "fix_input", en: "Invalid column" },
  "error.400.tasks_invalid_feature_defs": { status: 400, params: [], remediation: "fix_input", en: "Invalid custom-field schema" },
  "error.400.tasks_invalid_features": { status: 400, params: [], remediation: "fix_input", en: "Invalid custom-field values for this board" },
  "error.400.tasks_invalid_move": { status: 400, params: [], remediation: "fix_input", en: "Invalid move: unknown target column or position" },
  "error.400.tasks_unknown_preset": { status: 400, params: [], remediation: "fix_input", en: "Unknown board preset" },
  ...
  "error.403.tasks_forbidden": { status: 403, params: [], remediation: "retry", en: "You do not have permission to perform this action" },
  ...
  "error.404.tasks_board_not_found": { status: 404, params: [], remediation: "retry", en: "Board not found" },
  "error.404.tasks_checklist_item_not_found": { status: 404, params: [], remediation: "retry", en: "Checklist item not found" },
  "error.404.tasks_column_not_found": { status: 404, params: [], remediation: "retry", en: "Column not found" },
  "error.404.tasks_comment_not_found": { status: 404, params: [], remediation: "retry", en: "Comment not found" },
  "error.404.tasks_task_not_found": { status: 404, params: [], remediation: "retry", en: "Task not found" },
  ...
  "error.409.tasks_column_exists": { status: 409, params: [], remediation: "fix_input", en: "A column with this key already exists on the board" },
  "error.409.tasks_transition_not_allowed": { status: 409, params: [], remediation: "fix_input", en: "This move is not allowed by the board workflow" },
  ...
  "error.503.tasks_scope_unresolved": { status: 503, params: [], remediation: "retry", en: "Cannot determine which workspace this board belongs to" },
} as const;

export type TasksErrorCode = keyof typeof TASKS_ERRORS;

/** Every backend error code this module can surface, sorted. */
export const TASKS_ERROR_CODES: readonly TasksErrorCode[] = [
  ...
  "error.400.tasks_invalid_checklist_state",
  "error.400.tasks_invalid_column",
  "error.400.tasks_invalid_feature_defs",
  "error.400.tasks_invalid_features",
  "error.400.tasks_invalid_move",
  "error.400.tasks_unknown_preset",
  ...
  "error.403.tasks_forbidden",
  "error.403.verification_enrollment_required",
  "error.403.verification_required",
  "error.404.ad_not_found",
  "error.404.not_found",
  "error.404.tasks_board_not_found",
  "error.404.tasks_checklist_item_not_found",
  "error.404.tasks_column_not_found",
  "error.404.tasks_comment_not_found",
  "error.404.tasks_task_not_found",
  "error.404.verification_challenge_not_found",
  "error.405.method_not_allowed",
  "error.406.not_acceptable",
  "error.408.request_timeout",
  "error.409.conflict",
  "error.409.tasks_column_exists",
  ...
  "error.503.tasks_scope_unresolved",
];
 ...
 */
export const tasksErrorBundleEn: Record<TasksErrorCode, string> = {
  ...
  "error.400.tasks_invalid_checklist_state": "Checklist state must be one of: pending, done, failed",
  "error.400.tasks_invalid_column": "Invalid column",
  "error.400.tasks_invalid_feature_defs": "Invalid custom-field schema",
  "error.400.tasks_invalid_features": "Invalid custom-field values for this board",
  "error.400.tasks_invalid_move": "Invalid move: unknown target column or position",
  "error.400.tasks_unknown_preset": "Unknown board preset",
  ...
  "error.403.tasks_forbidden": "You do not have permission to perform this action",
  ...
  "error.404.tasks_board_not_found": "Board not found",
  "error.404.tasks_checklist_item_not_found": "Checklist item not found",
  "error.404.tasks_column_not_found": "Column not found",
  "error.404.tasks_comment_not_found": "Comment not found",
  "error.404.tasks_task_not_found": "Task not found",
  ...
  "error.409.tasks_column_exists": "A column with this key already exists on the board",
  "error.409.tasks_transition_not_allowed": "This move is not allowed by the board workflow",
  ...
  "error.503.tasks_scope_unresolved": "Cannot determine which workspace this board belongs to",
};
