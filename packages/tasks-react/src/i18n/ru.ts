 ...
 * stapel-tasks ships a `translations/errors.ru.json` — spread it in
...
export const tasksI18nBundleRu: I18nDictionary = {
  ...
  "tasks.nav.overview": "Обзор",
  "tasks.panel.empty": "Здесь пока ничего нет.",
  "tasks.panel.loading": "Загрузка…",
};
 ...
 */
export function registerTasksI18nRu(
  engine: I18nEngine,
  locale = "ru"
): void {
