...
export interface VideoErrorSpec {
...
/**
 * The VIDEO_ERRORS map — every `error.*` key stapel-auth can raise, keyed by its
...
export const VIDEO_ERRORS = {
  ...
  "error.400.video_call_invalid_callee": { status: 400, params: [], remediation: "fix_input", en: "callee_id must name another user" },
  "error.400.video_invalid_access_level": { status: 400, params: [], remediation: "fix_input", en: "access_level must be one of: public, scope_trusted, restricted" },
  "error.400.video_invalid_usage_period": { status: 400, params: [], remediation: "fix_input", en: "month must be YYYY-MM, months a positive integer, and tz an IANA time zone" },
  "error.400.video_invalid_webhook": { status: 400, params: [], remediation: "fix_input", en: "Invalid or unverifiable provider webhook" },
  ...
  "error.403.video_call_not_allowed": { status: 403, params: [], remediation: "retry", en: "You may not call this person" },
  "error.403.video_join_denied": { status: 403, params: [], remediation: "retry", en: "You were denied entry to this room" },
  "error.403.video_not_room_host": { status: 403, params: [], remediation: "retry", en: "Only the room host may perform this action" },
  "error.403.video_not_room_participant": { status: 403, params: [], remediation: "retry", en: "Only a participant of this room may see this" },
  ...
  "error.404.video_call_not_found": { status: 404, params: [], remediation: "retry", en: "Call not found" },
  "error.404.video_participant_not_found": { status: 404, params: [], remediation: "retry", en: "Waiting participant not found" },
  "error.404.video_room_not_found": { status: 404, params: [], remediation: "retry", en: "Room not found" },
  "error.404.video_scope_not_found": { status: 404, params: [], remediation: "retry", en: "Scope not found" },
  ...
  "error.409.video_call_busy": { status: 409, params: [], remediation: "fix_input", en: "You are already on a call" },
  "error.409.video_call_state": { status: 409, params: [], remediation: "fix_input", en: "This call is no longer in a state that allows this" },
  ...
  "error.503.video_call_provider_unavailable": { status: 503, params: [], remediation: "retry", en: "The video backend is unavailable right now" },
} as const;
...
export const VIDEO_ERROR_CODES: readonly VideoErrorCode[] = [
  ...
  "error.400.video_call_invalid_callee",
  ...
  "error.403.video_call_not_allowed",
  "error.403.video_join_denied",
 ...
 */
export const videoErrorBundleEn: Record<VideoErrorCode, string> = {
  ...
  "error.400.video_call_invalid_callee": "callee_id must name another user",
  "error.400.video_invalid_access_level": "access_level must be one of: public, scope_trusted, restricted",
  "error.400.video_invalid_usage_period": "month must be YYYY-MM, months a positive integer, and tz an IANA time zone",
  "error.400.video_invalid_webhook": "Invalid or unverifiable provider webhook",
  ...
  "error.403.video_call_not_allowed": "You may not call this person",
  "error.403.video_join_denied": "You were denied entry to this room",
  "error.403.video_not_room_host": "Only the room host may perform this action",
  "error.403.video_not_room_participant": "Only a participant of this room may see this",
  ...
  "error.404.video_call_not_found": "Call not found",
  "error.404.video_participant_not_found": "Waiting participant not found",
  "error.404.video_room_not_found": "Room not found",
  "error.404.video_scope_not_found": "Scope not found",
  ...
  "error.409.video_call_state": "This call is no longer in a state that allows this",
  ...
  "error.503.video_call_provider_unavailable": "The video backend is unavailable right now",
};
