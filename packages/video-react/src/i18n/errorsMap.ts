 ...
 */
import { VIDEO_ERRORS } from "./generated/errors.gen.js";
 ...
 */
export function explainVideoError(code: string): Remediation | undefined {
  return (VIDEO_ERRORS as Record<string, { remediation: Remediation }>)[code]
    ?.remediation;
}
