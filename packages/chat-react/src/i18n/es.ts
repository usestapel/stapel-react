...
export const chatI18nBundleEs: I18nDictionary = {
  ...
  "chat.attach.add": "Adjuntar",
  "chat.attach.photo": "Foto o vídeo",
  "chat.attach.file": "Documento",
  "chat.attach.remove": "Quitar este adjunto",
  "chat.attach.retry": "Reintentar este adjunto",
  "chat.attach.uploading": "Subiendo…",
  "chat.attach.failed": "Este adjunto no se ha subido",
  "chat.attach.pending": "Esperando a los adjuntos",
  "chat.attach.blocked.full": "Puedes adjuntar como máximo {max} a un mensaje",
  "chat.attach.blocked.pending": "Espera a que terminen de subirse los adjuntos",
  "chat.attach.blocked.failed": "Quita o reintenta los adjuntos que han fallado",
  "chat.attach.blocked.disabled": "Los adjuntos están desactivados en este chat",
  "chat.attach.voice": "Mensaje de voz",

  "chat.attachment.image_alt": "Foto adjunta",
  "chat.attachment.gif_alt": "Animación adjunta",
  "chat.attachment.video_alt": "Vídeo adjunto",
  "chat.attachment.audio_alt": "Mensaje de voz",
  "chat.attachment.document": "Documento",
  "chat.attachment.open": "Abrir",
  "chat.attachment.download": "Descargar",
  "chat.attachment.no_link": "Este archivo no tiene enlace para abrirlo",
