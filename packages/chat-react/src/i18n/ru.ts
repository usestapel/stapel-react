...
export const chatI18nBundleRu: I18nDictionary = {
  ...
  "chat.attach.add": "Прикрепить",
  "chat.attach.photo": "Фото или видео",
  "chat.attach.file": "Документ",
  "chat.attach.remove": "Убрать это вложение",
  "chat.attach.retry": "Повторить это вложение",
  "chat.attach.uploading": "Загружается…",
  "chat.attach.failed": "Это вложение не загрузилось",
  "chat.attach.pending": "Ждём вложения",
  "chat.attach.blocked.full": "К одному сообщению можно прикрепить не больше {max}",
  "chat.attach.blocked.pending": "Дождитесь окончания загрузки вложений",
  "chat.attach.blocked.failed": "Уберите или повторите вложения, которые не загрузились",
  "chat.attach.blocked.disabled": "В этом чате вложения отключены",
  "chat.attach.voice": "Голосовое сообщение",

  "chat.attachment.image_alt": "Прикреплённое фото",
  "chat.attachment.gif_alt": "Прикреплённая анимация",
  "chat.attachment.video_alt": "Прикреплённое видео",
  "chat.attachment.audio_alt": "Голосовое сообщение",
  "chat.attachment.document": "Документ",
  "chat.attachment.open": "Открыть",
  "chat.attachment.download": "Скачать",
  "chat.attachment.no_link": "У этого файла нет ссылки для открытия",
