...
export const CHAT_ERRORS = {
  ...
  "error.400.chat_incomplete_subject": { status: 400, params: [], remediation: "fix_input", en: "A subject needs both a type and a key" },
  "error.400.chat_invalid_attachment": { status: 400, params: [], remediation: "fix_input", en: "An attachment is malformed or its preview is too large" },
  ...
  "error.400.chat_message_deleted": { status: 400, params: [], remediation: "fix_input", en: "This message has been deleted" },
  "error.400.chat_not_editable": { status: 400, params: [], remediation: "fix_input", en: "This message can no longer be edited" },
  ...
  "error.400.chat_unknown_activity_state": { status: 400, params: [], remediation: "fix_input", en: "This activity state is not registered in this deployment" },
  "error.400.chat_unknown_attachment_type": { status: 400, params: [], remediation: "fix_input", en: "This attachment type is not registered in this deployment" },
  "error.400.chat_unknown_subject_type": { status: 400, params: [], remediation: "fix_input", en: "This subject type is not registered in this deployment" },
  ...
  "error.403.chat_not_author": { status: 403, params: [], remediation: "retry", en: "Only the author may edit or delete this message" },
  ...
  "error.403.chat_send_refused": { status: 403, params: [], remediation: "retry", en: "This message could not be sent" },
  ...
  "error.404.chat_message_not_found": { status: 404, params: [], remediation: "retry", en: "Message not found in this conversation" },
  ...
  "error.503.chat_blocks_unavailable": { status: 503, params: [], remediation: "retry", en: "Messaging is temporarily unavailable, please try again" },
...
export const CHAT_ERROR_CODES: readonly ChatErrorCode[] = [
  ...
  "error.400.chat_message_deleted",
  "error.400.chat_not_editable",
...
export const chatErrorBundleEn: Record<ChatErrorCode, string> = {
  ...
  "error.400.chat_incomplete_subject": "A subject needs both a type and a key",
  "error.400.chat_invalid_attachment": "An attachment is malformed or its preview is too large",
  ...
  "error.400.chat_message_deleted": "This message has been deleted",
  "error.400.chat_not_editable": "This message can no longer be edited",
  "error.400.chat_not_support": "This operation applies only to support conversations",
  "error.400.chat_unknown_activity_state": "This activity state is not registered in this deployment",
  "error.400.chat_unknown_attachment_type": "This attachment type is not registered in this deployment",
  "error.400.chat_unknown_subject_type": "This subject type is not registered in this deployment",
  ...
  "error.403.chat_not_author": "Only the author may edit or delete this message",
  ...
  "error.403.chat_send_refused": "This message could not be sent",
  ...
  "error.404.chat_message_not_found": "Message not found in this conversation",
  ...
  "error.503.chat_blocks_unavailable": "Messaging is temporarily unavailable, please try again",
