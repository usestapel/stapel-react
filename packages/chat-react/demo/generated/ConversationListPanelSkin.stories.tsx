...
export const Left = (): ReactElement => renderDemoVariant(demo, "left");
Left.storyName = "left";
Left.parameters = { stapel: {"viewport":"phone","step":"left"} };
export const HostSubjectLine = (): ReactElement => renderDemoVariant(demo, "host-subject-line");
HostSubjectLine.storyName = "host-subject-line";
HostSubjectLine.parameters = { stapel: {"viewport":"phone","step":"host-subject"} };
