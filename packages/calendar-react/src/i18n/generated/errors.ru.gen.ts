...
import type { CalendarErrorCode } from "./errors.gen.js";

/**
 * `ru` texts for the backend error codes this catalog carries.
 *
 * PARTIAL, and deliberately typed to say so: 7 key(s) owned by
 * stapel_calendar are absent, because that owner ships no locale catalog
 ...
 */
export const calendarErrorBundleRu: Partial<Record<CalendarErrorCode, string>> = {
