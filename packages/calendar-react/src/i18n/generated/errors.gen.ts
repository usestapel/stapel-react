...
export interface CalendarErrorSpec {
...
/**
 * The CALENDAR_ERRORS map — every `error.*` key stapel-auth can raise, keyed by its
...
export const CALENDAR_ERRORS = {
  ...
  "error.400.calendar_invalid_range": { status: 400, params: [], remediation: "fix_input", en: "Invalid time range" },
  "error.400.calendar_invalid_recurrence": { status: 400, params: [], remediation: "fix_input", en: "Invalid recurrence specification" },
  "error.400.calendar_invalid_rsvp": { status: 400, params: [], remediation: "fix_input", en: "RSVP must be one of: accepted, tentative, declined" },
  "error.400.calendar_invalid_slot_minutes": { status: 400, params: [], remediation: "fix_input", en: "slot_minutes must be a positive integer" },
  ...
  "error.403.calendar_not_event_owner": { status: 403, params: [], remediation: "retry", en: "Only the event owner may perform this action" },
  ...
  "error.404.calendar_event_not_found": { status: 404, params: [], remediation: "retry", en: "Event not found" },
  "error.404.calendar_not_invited": { status: 404, params: [], remediation: "fix_input", en: "You are not invited to this event" },
...
export const CALENDAR_ERROR_CODES: readonly CalendarErrorCode[] = [
  ...
  "error.404.calendar_event_not_found",
 ...
 */
export const calendarErrorBundleEn: Record<CalendarErrorCode, string> = {
  "error.400.bad_request": "Bad request",
  "error.400.calendar_invalid_range": "Invalid time range",
  "error.400.calendar_invalid_recurrence": "Invalid recurrence specification",
  "error.400.calendar_invalid_rsvp": "RSVP must be one of: accepted, tentative, declined",
  "error.400.calendar_invalid_slot_minutes": "slot_minutes must be a positive integer",
  ...
  "error.403.calendar_not_event_owner": "Only the event owner may perform this action",
  ...
  "error.404.calendar_event_not_found": "Event not found",
  "error.404.calendar_not_invited": "You are not invited to this event",
