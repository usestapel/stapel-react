...
import demo from "../ResummarizeActionSkin.demo.js";

export default { title: "recordings-react / Rewrite summary" };

export const Default = (): ReactElement => renderDemoVariant(demo, "default");
Default.storyName = "default";
Default.parameters = { stapel: {"viewport":"desktop","step":"available"} };
