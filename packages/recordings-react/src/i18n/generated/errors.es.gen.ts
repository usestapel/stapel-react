...
export const recordingsErrorBundleEs: Record<RecordingsErrorCode, string> = {
  ...
  "error.400.recording_multipart_parts_invalid": "La lista de partes de la subida multiparte es incorrecta o supera las {max_parts} partes",
  "error.400.recording_upload_size_invalid": "El tamaño de la subida debe ser un número positivo de bytes, como máximo {limit}",
  ...
  "error.413.recording_too_large": "La subida de {size} bytes supera el tamaño máximo permitido de {limit} bytes",
