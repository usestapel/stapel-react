...
export const RECORDINGS_ERRORS = {
  ...
  "error.400.recording_multipart_parts_invalid": { status: 400, params: ["max_parts"], remediation: "fix_input", en: "Multipart part list is malformed or exceeds {max_parts} parts" },
  "error.400.recording_upload_size_invalid": { status: 400, params: ["limit"], remediation: "fix_input", en: "Upload size must be a positive number of bytes, at most {limit}" },
  ...
  "error.401.share_passcode_required": { status: 401, params: [], remediation: "reauthenticate", en: "This share link requires a passcode" },
  ...
  "error.402.recording_payment_required": { status: 402, params: [], remediation: "retry", en: "This action requires available credit" },
  ...
  "error.403.recording_action_denied": { status: 403, params: [], remediation: "retry", en: "You are not allowed to do that with this recording" },
  "error.403.recording_workspace_forbidden": { status: 403, params: [], remediation: "retry", en: "You are not a member of this workspace" },
  "error.403.share_permission_denied": { status: 403, params: [], remediation: "retry", en: "This share link does not grant that" },
  ...
  "error.404.share_not_found": { status: 404, params: [], remediation: "retry", en: "Share link not found" },
  ...
  "error.409.recording_invalid_state": { status: 409, params: [], remediation: "fix_input", en: "Recording is not in a valid state for this action" },
  "error.409.recording_media_not_stored": { status: 409, params: [], remediation: "fix_input", en: "This recording has no media file" },
  "error.409.recording_no_transcript": { status: 409, params: [], remediation: "fix_input", en: "This recording has no transcript to summarize yet" },
  ...
  "error.413.recording_too_large": { status: 413, params: ["size","limit"], remediation: "retry", en: "Upload of {size} bytes exceeds the maximum allowed size of {limit} bytes" },
  "error.415.recording_unsupported_media": { status: 415, params: [], remediation: "retry", en: "Upload file type is not supported" },
  ...
  "error.429.share_unlock_throttled": { status: 429, params: [], remediation: "wait_and_retry", en: "Too many attempts — try again later" },
  ...
  "error.503.recording_media_unavailable": { status: 503, params: [], remediation: "retry", en: "Media delivery is not available" },
  "error.503.recording_summarize_unavailable": { status: 503, params: [], remediation: "retry", en: "Summaries are not available" },
  "error.503.recording_upload_unverifiable": { status: 503, params: [], remediation: "retry", en: "Upload could not be verified" },
} as const;
...
export const recordingsErrorBundleEn: Record<RecordingsErrorCode, string> = {
  ...
  "error.400.recording_multipart_parts_invalid": "Multipart part list is malformed or exceeds {max_parts} parts",
  "error.400.recording_upload_size_invalid": "Upload size must be a positive number of bytes, at most {limit}",
  ...
  "error.401.share_passcode_required": "This share link requires a passcode",
  "error.401.unauthorized": "Authentication required",
  "error.402.payment_required": "Payment required",
  "error.402.recording_payment_required": "This action requires available credit",
  ...
  "error.403.recording_action_denied": "You are not allowed to do that with this recording",
  "error.403.recording_workspace_forbidden": "You are not a member of this workspace",
  "error.403.share_permission_denied": "This share link does not grant that",
  ...
  "error.404.share_not_found": "Share link not found",
  ...
  "error.409.recording_invalid_state": "Recording is not in a valid state for this action",
  "error.409.recording_media_not_stored": "This recording has no media file",
  "error.409.recording_no_transcript": "This recording has no transcript to summarize yet",
  "error.410.gone": "Resource has been permanently removed",
  "error.413.payload_too_large": "Request body is too large",
  "error.413.recording_too_large": "Upload of {size} bytes exceeds the maximum allowed size of {limit} bytes",
  "error.415.recording_unsupported_media": "Upload file type is not supported",
  ...
  "error.429.share_unlock_throttled": "Too many attempts — try again later",
  ...
  "error.503.recording_media_unavailable": "Media delivery is not available",
  "error.503.recording_summarize_unavailable": "Summaries are not available",
  "error.503.recording_upload_unverifiable": "Upload could not be verified",
};
