 ...
 */
import { RECORDINGS_ERRORS } from "./generated/errors.gen.js";
 ...
 */
export function explainRecordingsError(code: string): Remediation | undefined {
  return (RECORDINGS_ERRORS as Record<string, { remediation: Remediation }>)[code]
    ?.remediation;
}
