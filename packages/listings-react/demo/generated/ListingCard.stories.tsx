...
export const GridCell = (): ReactElement => renderDemoVariant(demo, "grid cell");
GridCell.storyName = "grid cell";
GridCell.parameters = { stapel: {"viewport":"phone","step":"member_stacked_320"} };
export const ListRow = (): ReactElement => renderDemoVariant(demo, "list row");
ListRow.storyName = "list row";
ListRow.parameters = { stapel: {"viewport":"desktop","step":"member_row_960"} };
