...
export const listingsI18nBundleRu: I18nDictionary = {
  ...
  "listings.detail.question_available": "Здравствуйте! Ещё продаётся?",
  "listings.detail.question_price": "Здравствуйте! Торг уместен?",
  "listings.detail.question_viewing": "Здравствуйте! Можно посмотреть?",
  "listings.detail.question_delivery": "Здравствуйте! Доставка есть?",
  "listings.detail.question_job_open": "Здравствуйте! Вакансия ещё открыта?",
  "listings.detail.question_job_schedule": "Здравствуйте! Какой график работы?",
  "listings.detail.question_job_apply": "Здравствуйте! Куда прислать резюме?",
  "listings.detail.question_service_available":
    "Здравствуйте! Вы ещё оказываете эту услугу?",
  "listings.detail.question_service_price": "Здравствуйте! Сколько это будет стоить?",
  "listings.detail.question_service_slot": "Здравствуйте! Когда есть свободное время?",
  "listings.detail.gallery_open": "Посмотреть все фото крупно",
  "listings.detail.gallery_prev": "Предыдущее фото",
  "listings.detail.gallery_next": "Следующее фото",
  "listings.detail.gallery_close": "Закрыть фото",
