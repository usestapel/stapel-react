...
export const listingsI18nBundleEs: I18nDictionary = {
  ...
  "listings.detail.question_available": "¡Hola! ¿Sigue disponible?",
  "listings.detail.question_price": "¡Hola! ¿El precio es negociable?",
  "listings.detail.question_viewing": "¡Hola! ¿Puedo verlo en persona?",
  "listings.detail.question_delivery": "¡Hola! ¿Hacen envíos?",
  "listings.detail.question_job_open": "¡Hola! ¿La vacante sigue abierta?",
  "listings.detail.question_job_schedule": "¡Hola! ¿Cuál es el horario?",
  "listings.detail.question_job_apply": "¡Hola! ¿Dónde envío mi currículum?",
  "listings.detail.question_service_available":
    "¡Hola! ¿Sigue ofreciendo este servicio?",
  "listings.detail.question_service_price": "¡Hola! ¿Cuánto costaría?",
  "listings.detail.question_service_slot": "¡Hola! ¿Cuándo tiene hueco?",
  "listings.detail.gallery_open": "Ver todas las fotos en grande",
  "listings.detail.gallery_prev": "Foto anterior",
  "listings.detail.gallery_next": "Foto siguiente",
  "listings.detail.gallery_close": "Cerrar las fotos",
