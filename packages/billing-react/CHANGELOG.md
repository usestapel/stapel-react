...
- 6d59bcd: `<Subscription>` asks the SERVER whether the subscription is active.
...
- 1f8df08: Regenerated against **stapel-billing 0.16.1**: the pin was two minors behind
...
- bcc7dd5: Regenerated against **stapel-billing 0.14.0**: the pin was two minors behind
...
- 218eee5: Regenerated against **stapel-billing 0.12.0**: the declared backend contract moves from `>=0.11 <0.12` to `>=0.12 <0.13` in `manifest.json` and `llms.txt`.
