/**
 * Zero-flow registry shim (slim wave §21/S3). stapel-billing annotates no
 * `@flow_step` yet — its backend `docs/flows.json` carries no `billing.*`
 ...
 */
export const BILLING_FLOWS = {} as const;
