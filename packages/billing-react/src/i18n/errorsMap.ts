 ...
 */
import { BILLING_ERRORS } from "./generated/errors.gen.js";
 ...
 */
export function explainBillingError(code: string): Remediation | undefined {
  return (BILLING_ERRORS as Record<string, { remediation: Remediation }>)[code]
    ?.remediation;
}
