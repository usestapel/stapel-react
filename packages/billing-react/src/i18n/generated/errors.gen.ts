...
/**
 * The BILLING_ERRORS map — every `error.*` key stapel-auth can raise, keyed by its
...
export const BILLING_ERRORS = {
  "error.400.amount_invalid": { status: 400, params: [], remediation: "fix_input", en: "Amount must be a positive integer" },
  ...
  "error.400.invalid_package": { status: 400, params: [], remediation: "fix_input", en: "Invalid credit package" },
  ...
  "error.402.insufficient_credits": { status: 402, params: [], remediation: "fix_input", en: "Insufficient credits" },
  ...
  "error.403.forbidden_billing": { status: 403, params: [], remediation: "contact_support", en: "Forbidden: cannot manage this billing account" },
  ...
  "error.404.subscription_not_found": { status: 404, params: [], remediation: "fix_input", en: "Subscription not found" },
  "error.404.transaction_not_found": { status: 404, params: [], remediation: "fix_input", en: "Transaction not found" },
  ...
  "error.404.wallet_not_found": { status: 404, params: [], remediation: "fix_input", en: "Wallet not found" },
  ...
  "error.409.duplicate_webhook_event": { status: 409, params: [], remediation: "retry", en: "Stripe event already processed" },
  "error.409.subscription_not_paid": { status: 409, params: [], remediation: "verify", en: "There is no paid subscription to cancel" },
 ...
 */
export const billingErrorBundleEn: Record<BillingErrorCode, string> = {
  "error.400.amount_invalid": "Amount must be a positive integer",
  ...
  "error.400.invalid_package": "Invalid credit package",
  ...
  "error.402.insufficient_credits": "Insufficient credits",
  "error.402.payment_required": "Payment required",
  "error.403.forbidden": "You do not have permission to perform this action",
  "error.403.forbidden_billing": "Forbidden: cannot manage this billing account",
  ...
  "error.404.subscription_not_found": "Subscription not found",
  "error.404.transaction_not_found": "Transaction not found",
  "error.404.verification_challenge_not_found": "Verification challenge not found or expired",
  "error.404.wallet_not_found": "Wallet not found",
  ...
  "error.409.duplicate_webhook_event": "Stripe event already processed",
  "error.409.subscription_not_paid": "There is no paid subscription to cancel",
