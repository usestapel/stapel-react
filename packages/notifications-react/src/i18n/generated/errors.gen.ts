...
export interface NotificationsErrorSpec {
...
/**
 * The NOTIFICATIONS_ERRORS map — every `error.*` key stapel-auth can raise, keyed by its
...
export const NOTIFICATIONS_ERRORS = {
  ...
  "error.400.read_target_required": { status: 400, params: [], remediation: "fix_input", en: "Send exactly one of: a non-empty \"ids\" list, or \"all\": true." },
  "error.400.too_many_ids": { status: 400, params: [], remediation: "fix_input", en: "Too many ids in one request. Send fewer, or \"all\": true." },
  ...
  "error.404.device_not_found": { status: 404, params: [], remediation: "verify", en: "Device not found, or it is not registered to you." },
  "error.404.not_found": { status: 404, params: [], remediation: "retry", en: "Requested resource not found" },
  "error.404.token_not_found": { status: 404, params: [], remediation: "fix_input", en: "Device token not found." },
...
export type NotificationsErrorCode = keyof typeof NOTIFICATIONS_ERRORS;

/** Every backend error code this module can surface, sorted. */
export const NOTIFICATIONS_ERROR_CODES: readonly NotificationsErrorCode[] = [
  ...
  "error.400.read_target_required",
 ...
 */
export const notificationsErrorBundleEn: Record<NotificationsErrorCode, string> = {
  ...
  "error.400.read_target_required": "Send exactly one of: a non-empty \"ids\" list, or \"all\": true.",
  "error.400.too_many_ids": "Too many ids in one request. Send fewer, or \"all\": true.",
  ...
  "error.404.device_not_found": "Device not found, or it is not registered to you.",
  "error.404.not_found": "Requested resource not found",
  "error.404.token_not_found": "Device token not found.",
