 ...
 * compilation on drift. The pair-owned UI keys (`NOTIFICATIONS_I18N_KEYS`) are NOT
 * translated to Spanish yet and deliberately fall back to their English text
 * through the en floor that {@link registerNotificationsI18nEs} registers underneath.
