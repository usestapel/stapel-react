/**
 * @stapel/translate-react's contribution to the scripted-fullstack navigation contract
 ...
 * ── The one entry below ────────────────────────────────────────────────────
 *
 * It names `TranslatePanel` from `./default` — a component that exists, which
...
export const navEntries: readonly NavEntry[] = [
    {
      ...
      "labelKey": "translate.nav.overview",
