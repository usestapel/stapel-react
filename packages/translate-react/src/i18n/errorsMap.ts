 ...
 */
import { TRANSLATE_ERRORS } from "./generated/errors.gen.js";
 ...
 */
export function explainTranslateError(code: string): Remediation | undefined {
  return (TRANSLATE_ERRORS as Record<string, { remediation: Remediation }>)[code]
    ?.remediation;
}
