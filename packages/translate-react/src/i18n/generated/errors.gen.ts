...
export interface TranslateErrorSpec {
...
/**
 * The TRANSLATE_ERRORS map — every `error.*` key stapel-auth can raise, keyed by its
...
export type TranslateErrorCode = keyof typeof TRANSLATE_ERRORS;

/** Every backend error code this module can surface, sorted. */
export const TRANSLATE_ERROR_CODES: readonly TranslateErrorCode[] = [
 ...
 */
export const translateErrorBundleEn: Record<TranslateErrorCode, string> = {
