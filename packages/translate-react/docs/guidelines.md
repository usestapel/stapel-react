...
for @stapel/translate-react and what has been decided for its screens. It is a stub on
...
- 2026-.. — scaffolded; `TranslatePanel` is a skeleton (themed frame +
