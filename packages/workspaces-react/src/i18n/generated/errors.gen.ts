...
export interface WorkspacesErrorSpec {
...
/**
 * The WORKSPACES_ERRORS map — every `error.*` key stapel-auth can raise, keyed by its
 ...
 */
export const WORKSPACES_ERRORS = {
  "error.400.already_workspace_member": { status: 400, params: [], remediation: "fix_input", en: "User is already a member of this workspace" },
  ...
  "error.400.invalid_provision_username": { status: 400, params: [], remediation: "fix_input", en: "Invalid username for a provisioned account" },
  "error.400.invalid_role": { status: 400, params: [], remediation: "fix_input", en: "Invalid role" },
  "error.400.invitation_already_used": { status: 400, params: [], remediation: "fix_input", en: "Invitation has already been used" },
  "error.400.invitation_declined": { status: 400, params: [], remediation: "contact_support", en: "Invitation has been declined" },
  "error.400.invitation_expired": { status: 400, params: [], remediation: "contact_support", en: "Invitation has expired" },
  "error.400.invitation_revoked": { status: 400, params: [], remediation: "contact_support", en: "Invitation has been revoked" },
  ...
  "error.400.workspace_slug_taken": { status: 400, params: [], remediation: "fix_input", en: "Workspace slug is already taken" },
  "error.401.unauthorized": { status: 401, params: [], remediation: "reauthenticate", en: "Authentication required" },
  "error.402.entitlement_required": { status: 402, params: [], remediation: "fix_input", en: "The workspace owner's plan does not include this feature" },
  "error.402.member_limit_reached": { status: 402, params: ["limit"], remediation: "fix_input", en: "The workspace member limit ({limit}) has been reached" },
  ...
  "error.403.forbidden_workspace": { status: 403, params: [], remediation: "contact_support", en: "You do not have access to this workspace" },
  "error.403.last_owner_cannot_be_removed": { status: 403, params: [], remediation: "fix_input", en: "The last owner cannot be removed; transfer ownership first" },
  "error.403.membership_suspended": { status: 403, params: ["reason"], remediation: "fix_input", en: "Your membership in this workspace is suspended ({reason})" },
  "error.403.missing_capability": { status: 403, params: ["capability"], remediation: "contact_support", en: "Your role does not include the {capability} capability in this workspace" },
  "error.403.network_blocked": { status: 403, params: [], remediation: "contact_support", en: "Requests from this network are not allowed" },
  "error.403.role_exceeds_inviter_rank": { status: 403, params: ["role"], remediation: "fix_input", en: "You cannot grant a role that outranks your own ({role})" },
  ...
  "error.403.workspace_creation_closed": { status: 403, params: [], remediation: "contact_support", en: "This instance does not allow you to create workspaces" },
  "error.404.ad_not_found": { status: 404, params: [], remediation: "retry", en: "Listing not found" },
  "error.404.invitation_not_found": { status: 404, params: [], remediation: "fix_input", en: "Invitation not found" },
  "error.404.member_not_found": { status: 404, params: [], remediation: "fix_input", en: "Member not found in this workspace" },
  ...
  "error.404.workspace_not_found": { status: 404, params: [], remediation: "fix_input", en: "Workspace not found" },
  ...
  "error.409.email_already_registered": { status: 409, params: [], remediation: "reauthenticate", en: "An account with this email already exists — log in instead" },
  "error.409.workspace_is_instance_default": { status: 409, params: [], remediation: "fix_input", en: "This is the instance's default workspace and cannot be deleted; point the instance at another workspace first" },
  "error.409.workspace_is_personal": { status: 409, params: [], remediation: "fix_input", en: "A personal workspace cannot be deleted on this instance — it is recreated the next time you sign in" },
  ...
  "error.429.invitation_grant_pending": { status: 429, params: ["retry_after"], remediation: "wait_and_retry", en: "A sign-in link for this invitation is still valid; you can request another one in {retry_after} seconds" },
  "error.429.invitation_resend_cooldown": { status: 429, params: ["retry_after"], remediation: "wait_and_retry", en: "This invitation was emailed recently; you can send it again in {retry_after} seconds" },
  ...
  "error.503.billing_unavailable": { status: 503, params: [], remediation: "wait_and_retry", en: "The billing service is unavailable; try again later" },
...
export const WORKSPACES_ERROR_CODES: readonly WorkspacesErrorCode[] = [
  "error.400.already_workspace_member",
  ...
  "error.403.workspace_creation_closed",
  ...
  "error.409.workspace_is_instance_default",
  "error.409.workspace_is_personal",
  "error.410.gone",
 ...
 */
export const workspacesErrorBundleEn: Record<WorkspacesErrorCode, string> = {
  "error.400.already_workspace_member": "User is already a member of this workspace",
  ...
  "error.400.invalid_provision_username": "Invalid username for a provisioned account",
  "error.400.invalid_role": "Invalid role",
  "error.400.invitation_already_used": "Invitation has already been used",
  "error.400.invitation_declined": "Invitation has been declined",
  "error.400.invitation_expired": "Invitation has expired",
  "error.400.invitation_revoked": "Invitation has been revoked",
  ...
  "error.400.workspace_slug_taken": "Workspace slug is already taken",
  "error.401.unauthorized": "Authentication required",
  "error.402.entitlement_required": "The workspace owner's plan does not include this feature",
  "error.402.member_limit_reached": "The workspace member limit ({limit}) has been reached",
  "error.402.payment_required": "Payment required",
  "error.403.forbidden": "You do not have permission to perform this action",
  "error.403.forbidden_workspace": "You do not have access to this workspace",
  "error.403.last_owner_cannot_be_removed": "The last owner cannot be removed; transfer ownership first",
  "error.403.membership_suspended": "Your membership in this workspace is suspended ({reason})",
  "error.403.missing_capability": "Your role does not include the {capability} capability in this workspace",
  "error.403.network_blocked": "Requests from this network are not allowed",
  "error.403.role_exceeds_inviter_rank": "You cannot grant a role that outranks your own ({role})",
  ...
  "error.403.workspace_creation_closed": "This instance does not allow you to create workspaces",
  "error.404.ad_not_found": "Listing not found",
  "error.404.invitation_not_found": "Invitation not found",
  "error.404.member_not_found": "Member not found in this workspace",
  ...
  "error.409.email_already_registered": "An account with this email already exists — log in instead",
  "error.409.workspace_is_instance_default": "This is the instance's default workspace and cannot be deleted; point the instance at another workspace first",
  "error.409.workspace_is_personal": "A personal workspace cannot be deleted on this instance — it is recreated the next time you sign in",
  ...
  "error.429.invitation_grant_pending": "A sign-in link for this invitation is still valid; you can request another one in {retry_after} seconds",
  "error.429.invitation_resend_cooldown": "This invitation was emailed recently; you can send it again in {retry_after} seconds",
  ...
  "error.503.billing_unavailable": "The billing service is unavailable; try again later",
