...
const demoBundleEn: Record<string, string> = {
  ...
  "demo.unit.hp": "hp",
  "demo.unit.km": "km",
  "demo.city.central": "Central depot",
  "demo.city.north": "North gate",
  "demo.city.south": "South gate",
  "demo.city.east": "East yard",
  "demo.city.west": "West yard",
  "demo.city.airport": "Airport counter",
  "demo.city.harbour": "Harbour office",
  "demo.city.station": "Station locker",
  "demo.city.university": "University campus",
  "demo.help.vin": "Seventeen characters, off the registration document.",
  "demo.help.mileage":
    "The reading on the odometer today, in kilometres. Buyers filter on it, so a listing whose mileage is missing is shown to fewer of them. If the car has had its cluster replaced, say so in the description rather than adjusting the number here.",
  "demo.example.mileage": "e.g. 128 400",
