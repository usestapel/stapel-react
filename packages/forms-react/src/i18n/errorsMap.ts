 ...
 */
import { FORMS_ERRORS } from "./generated/errors.gen.js";
 ...
 */
export function explainFormsError(code: string): Remediation | undefined {
  return (FORMS_ERRORS as Record<string, { remediation: Remediation }>)[code]
    ?.remediation;
}
