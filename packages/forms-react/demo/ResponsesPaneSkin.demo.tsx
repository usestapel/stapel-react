...
export default defineDemo({
  ...
  description:
    "Answers as their own version asked them: a submission records WHICH schema it answered, so reviewing an old response shows the questions that were actually put, not today's. Deleting and resending are not pre-gated on a guessed capability — the contract exposes none, and a guessed 'you may not' is the same defect as a dead button — but an ERASED row is gated, with the reason beside both controls.",
