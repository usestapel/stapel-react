...
- c5460df: forms: the pin moves to stapel-forms 0.6.2 — the responses page gains four optional filters in its types, and a thirteenth attributes-owned error key gets ru/es
...
- c03b3e0: Fix the six blank showcase stories and the two that photographed the wrong state.
  ...
  and still its own picture _after_ the network settles — the failure a static
