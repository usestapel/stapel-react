...
export interface ReviewsErrorSpec {
...
/**
 * The REVIEWS_ERRORS map — every `error.*` key stapel-auth can raise, keyed by its
...
export const REVIEWS_ERRORS = {
  ...
  "error.400.reviews_ambiguous_addressing": { status: 400, params: [], remediation: "fix_input", en: "Address the review list by a target (target_type + target_key) or by an owner (owner_key), not by both" },
  "error.400.reviews_duplicate_review": { status: 400, params: [], remediation: "fix_input", en: "You have already reviewed this target" },
  "error.400.reviews_invalid_moderation_action": { status: 400, params: [], remediation: "fix_input", en: "Moderation action must be one of: hide, publish" },
  "error.400.reviews_invalid_rating": { status: 400, params: [], remediation: "fix_input", en: "Rating is out of the allowed range" },
  "error.400.reviews_response_not_allowed": { status: 400, params: [], remediation: "fix_input", en: "Responses are not allowed for this target type" },
  "error.400.reviews_too_many_owner_keys": { status: 400, params: ["max"], remediation: "fix_input", en: "Too many owner keys in one request (max {max})" },
  "error.400.reviews_unknown_target_type": { status: 400, params: [], remediation: "fix_input", en: "Unknown review target type" },
  ...
  "error.403.reviews_anonymous_not_allowed": { status: 403, params: [], remediation: "retry", en: "A guest account may not leave a review" },
  "error.403.reviews_cannot_moderate": { status: 403, params: [], remediation: "retry", en: "You are not allowed to moderate reviews of this target" },
  "error.403.reviews_cannot_review": { status: 403, params: [], remediation: "retry", en: "You are not allowed to review this target" },
  ...
  "error.404.reviews_review_not_found": { status: 404, params: [], remediation: "retry", en: "Review not found" },
  ...
  "error.409.reviews_already_responded": { status: 409, params: [], remediation: "fix_input", en: "This review already has a response" },
...
export type ReviewsErrorCode = keyof typeof REVIEWS_ERRORS;

/** Every backend error code this module can surface, sorted. */
export const REVIEWS_ERROR_CODES: readonly ReviewsErrorCode[] = [
  ...
  "error.400.reviews_duplicate_review",
 ...
 */
export const reviewsErrorBundleEn: Record<ReviewsErrorCode, string> = {
  ...
  "error.400.reviews_ambiguous_addressing": "Address the review list by a target (target_type + target_key) or by an owner (owner_key), not by both",
  "error.400.reviews_duplicate_review": "You have already reviewed this target",
  "error.400.reviews_invalid_moderation_action": "Moderation action must be one of: hide, publish",
  "error.400.reviews_invalid_rating": "Rating is out of the allowed range",
  "error.400.reviews_response_not_allowed": "Responses are not allowed for this target type",
  "error.400.reviews_too_many_owner_keys": "Too many owner keys in one request (max {max})",
  "error.400.reviews_unknown_target_type": "Unknown review target type",
  ...
  "error.403.reviews_anonymous_not_allowed": "A guest account may not leave a review",
  "error.403.reviews_cannot_moderate": "You are not allowed to moderate reviews of this target",
  "error.403.reviews_cannot_review": "You are not allowed to review this target",
  ...
  "error.404.reviews_review_not_found": "Review not found",
  ...
  "error.409.reviews_already_responded": "This review already has a response",
