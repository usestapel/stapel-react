...
export const CompactFlat = (): ReactElement => renderDemoVariant(demo, "compact flat");
CompactFlat.storyName = "compact flat";
CompactFlat.parameters = { stapel: {"viewport":"desktop","step":"ready-compact-flat"} };
