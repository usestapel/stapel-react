...
export const CATEGORIES_ERRORS = {
  ...
  "error.404.categories_slug_not_found": { status: 404, params: ["slug"], remediation: "retry", en: "No category with slug '{slug}'" },
...
export const CATEGORIES_ERROR_CODES: readonly CategoriesErrorCode[] = [
 ...
 */
export const categoriesErrorBundleEn: Record<CategoriesErrorCode, string> = {
  ...
  "error.404.categories_slug_not_found": "No category with slug '{slug}'",
