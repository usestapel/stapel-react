...
export const StickyToolbar = (): ReactElement => renderDemoVariant(demo, "sticky-toolbar");
StickyToolbar.storyName = "sticky-toolbar";
StickyToolbar.parameters = { stapel: {"viewport":"phone","step":"sticky-toolbar"} };
