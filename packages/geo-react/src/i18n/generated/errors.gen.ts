...
/**
 * The GEO_ERRORS map — every `error.*` key stapel-auth can raise, keyed by its
...
export const GEO_ERRORS = {
  ...
  "error.400.geohash_required": { status: 400, params: [], remediation: "fix_input", en: "Geohash is required" },
  "error.400.invalid_ad_id": { status: 400, params: [], remediation: "fix_input", en: "Invalid advertisement ID" },
  "error.400.invalid_bbox": { status: 400, params: [], remediation: "fix_input", en: "Bounding box must be min_lon,min_lat,max_lon,max_lat" },
  "error.400.invalid_geojson": { status: 400, params: [], remediation: "fix_input", en: "GeoJSON file is invalid" },
  "error.400.invalid_import_status": { status: 400, params: [], remediation: "fix_input", en: "Cannot retry import with current status" },
  "error.400.invalid_params": { status: 400, params: [], remediation: "fix_input", en: "One or more query parameters are invalid" },
  "error.400.lat_lon_required": { status: 400, params: [], remediation: "fix_input", en: "Valid latitude and longitude are required" },
  "error.400.uuid_required": { status: 400, params: [], remediation: "fix_input", en: "Location UUID is required" },
  ...
  "error.502.geocoder_unavailable": { status: 502, params: [], remediation: "retry", en: "Geocoding provider is unavailable" },
  "error.503.mandate_unavailable": { status: 503, params: [], remediation: "retry", en: "Cannot verify workspace mandate right now" },
} as const;

export type GeoErrorCode = keyof typeof GEO_ERRORS;

/** Every backend error code this module can surface, sorted. */
export const GEO_ERROR_CODES: readonly GeoErrorCode[] = [
 ...
 */
export const geoErrorBundleEn: Record<GeoErrorCode, string> = {
  ...
  "error.400.geohash_required": "Geohash is required",
  "error.400.invalid_ad_id": "Invalid advertisement ID",
  "error.400.invalid_bbox": "Bounding box must be min_lon,min_lat,max_lon,max_lat",
  "error.400.invalid_geojson": "GeoJSON file is invalid",
  "error.400.invalid_import_status": "Cannot retry import with current status",
  "error.400.invalid_params": "One or more query parameters are invalid",
  "error.400.lat_lon_required": "Valid latitude and longitude are required",
  "error.400.uuid_required": "Location UUID is required",
  ...
  "error.502.geocoder_unavailable": "Geocoding provider is unavailable",
