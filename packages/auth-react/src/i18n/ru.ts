...
export const authI18nBundleRu: I18nDictionary = {
  ...
  "auth.ui.channel_email_inline": "адрес эл. почты",
  "auth.ui.channel_phone_inline": "номер телефона",
  ...
  "auth.admin.forbidden.title": "Этот раздел недоступен вашей учётной записи",
  "auth.admin.forbidden.hint":
    "Ваша роль не включает этот раздел, поэтому данные здесь нельзя ни прочитать, ни изменить. Доступ выдаёт администратор — повторная попытка ответа не изменит.",
  "auth.admin.forbidden.reason": "Ваша роль не включает этот раздел.",
