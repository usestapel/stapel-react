...
export interface GdprErrorSpec {
...
/**
 * The GDPR_ERRORS map — every `error.*` key stapel-auth can raise, keyed by its
...
export type GdprErrorCode = keyof typeof GDPR_ERRORS;

/** Every backend error code this module can surface, sorted. */
export const GDPR_ERROR_CODES: readonly GdprErrorCode[] = [
 ...
 */
export const gdprErrorBundleEn: Record<GdprErrorCode, string> = {
