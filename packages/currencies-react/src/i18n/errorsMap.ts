 ...
 */
import { CURRENCIES_ERRORS } from "./generated/errors.gen.js";
 ...
 */
export function explainCurrenciesError(code: string): Remediation | undefined {
  return (CURRENCIES_ERRORS as Record<string, { remediation: Remediation }>)[code]
    ?.remediation;
}
