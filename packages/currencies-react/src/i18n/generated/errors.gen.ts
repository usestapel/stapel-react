...
export interface CurrenciesErrorSpec {
...
/**
 * The CURRENCIES_ERRORS map — every `error.*` key stapel-auth can raise, keyed by its
 ...
 */
export const CURRENCIES_ERRORS = {
  ...
  "error.400.invalid_amount": { status: 400, params: [], remediation: "fix_input", en: "Amount is not a valid decimal number" },
  "error.400.unknown_currency": { status: 400, params: [], remediation: "fix_input", en: "Unknown or inactive currency code" },
  ...
  "error.502.rate_fetch_failed": { status: 502, params: [], remediation: "retry", en: "Exchange-rate source is unavailable" },
  "error.503.mandate_unavailable": { status: 503, params: [], remediation: "retry", en: "Cannot verify workspace mandate right now" },
} as const;

export type CurrenciesErrorCode = keyof typeof CURRENCIES_ERRORS;

/** Every backend error code this module can surface, sorted. */
export const CURRENCIES_ERROR_CODES: readonly CurrenciesErrorCode[] = [
  ...
  "error.400.invalid_amount",
  "error.400.unknown_currency",
 ...
 */
export const currenciesErrorBundleEn: Record<CurrenciesErrorCode, string> = {
  ...
  "error.400.invalid_amount": "Amount is not a valid decimal number",
  "error.400.unknown_currency": "Unknown or inactive currency code",
  ...
  "error.502.rate_fetch_failed": "Exchange-rate source is unavailable",
