...
export const PhoneClosed = (): ReactElement => renderDemoVariant(demo, "phone-closed");
PhoneClosed.storyName = "phone-closed";
PhoneClosed.parameters = { stapel: {"viewport":"phone","step":"trigger"} };
